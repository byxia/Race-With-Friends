...
function getSmallPicture (id, name,successCallback, errorCallback) {
	_sendAjaxRequest_(prepareURL(GET_SMALL_PICTURE, {id : id, name : name}),true,successCallback, errorCallback);
}

function getLargePicture (id, name,successCallback, errorCallback) {
	_sendAjaxRequest_(prepareURL(GET_LARGE_PICTURE, {id : id, name : name}),true,successCallback, errorCallback);
}

function getSquarePicture(id, name,successCallback, errorCallback){
	_sendAjaxRequest_(prepareURL(GET_SQUARE_PICTURE,{id : id, name : name}),true,successCallback, errorCallback);
}
